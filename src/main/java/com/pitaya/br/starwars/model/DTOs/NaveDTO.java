...
public class NaveDTO {
    ...
    public NaveDTO(Integer id, String nome, String modelo, String classeNave, String fabricante, String tamanho, String capacidadeDeCarga, Integer velocidadeMaxima, List<String> pilotos, List<String> filmes) {
        this.id = id;
        this.nome = nome;
        this.modelo = modelo;
